...
export default class ApiHandler {
  ...
  // open a channel, join a room and install some transient triggers
  connectSocket(params) {
    ...
    channel.join().receive("ok", (response) => {
      //Install a device transient trigger for connection events
      channel.push("watch", this.getConnectionTriggerPayload(device));

      //Install a device transient trigger for disconnection events
      channel.push("watch", this.getDisconnectionTriggerPayload(device));

      //Install a data transient trigger 
      channel.push(
        "watch",
  ...
  // return a device transient trigger for connection events
  ...
  // return a device transient trigger for disconnection events
  ...
  // return a data transient trigger on all paths
