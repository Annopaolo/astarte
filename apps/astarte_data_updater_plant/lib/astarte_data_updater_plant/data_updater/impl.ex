...
defmodule Astarte.DataUpdaterPlant.DataUpdater.Impl do
  ...
  def handle_control(state, "/producer/properties", payload, message_id, timestamp) do
    ...
    case maybe_inflate_purge_properties_payload(payload) do
      {:ok, decoded_payload} ->
  ...
  defp maybe_inflate_purge_properties_payload(<<_size_header::size(32), zlib_payload::binary>>) do
    _ =
  ...
  defp maybe_inflate_purge_properties_payload(payload) do
    _ =
  ...
  def handle_control(state, "/emptyCache", payload, message_id, timestamp) do
    ...
    encode_properties? = if payload == 2, do: false, else: true
