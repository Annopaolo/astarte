...
defmodule Astarte.DataUpdater.DeletionScheduler do
  ...
  defp start_device_deletion!() do
    ...
    |> Enum.each(&start_device_deletion/1)
  end

  defp start_device_deletion(%{"realm_name" => realm_name, "device_id" => device_id}) do
  ...
  defp should_handle_data_from_device?(realm_name, device_id) do
    encoded_device_id = Device.encode_device_id(device_id)
