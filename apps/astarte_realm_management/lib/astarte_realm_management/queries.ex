...
defmodule Astarte.RealmManagement.Queries do
  ...
  defp execute_batch(client, queries)
       when length(queries) < @max_batch_queries do
    batch =
    ...
    with {:ok, _result} <- DatabaseQuery.call(client, batch) do
      ...
      %{acc: _, msg: error_message} ->
        _ =
          Logger.warn("Failed batch due to database error: #{error_message}.",
            tag: "db_error"
          )
  ...
  def install_new_interface(client, interface_document, automaton) do
    ...
    {:ok, _} =
      if create_table_statement != "" do
        _ =
          Logger.info("Creating new interface table.",
            tag: "create_interface_table"
          )
  ...
  defp replace_automaton_acceptings_with_ids(
         accepting_states,
         interface_name,
         major
       ) do
    Enum.reduce(accepting_states, %{}, fn state, new_states ->
      ...
      Map.put(
        new_states,
        state_index,
        CQLUtils.endpoint_id(interface_name, major, endpoint)
      )
    end)
  end
  ...
  def update_interface_storage(
    ...
    _ =
      Logger.debug(
        "Interface update: going to add #{inspect(add_cols)} to #{table_name}.",
  ...
  def delete_interface_storage(
    ...
    with {:ok, result} <-
           devices_with_data_on_interface(client, interface_descriptor.name) do
  ...
  def is_any_device_using_interface?(client, interface_name) do
    ...
    devices_query =
      ...
      |> DatabaseQuery.put(
        :group_name,
        "devices-by-interface-#{interface_name}-v0"
      )
  ...
  def devices_with_data_on_interface(client, interface_name) do
    ...
    devices_query =
      ...
      |> DatabaseQuery.put(
        :group_name,
        "devices-with-data-on-interface-#{interface_name}-v0"
      )
      |> DatabaseQuery.consistency(:quorum)
  ...
  def delete_values(
    ...
    with {:ok, _res} <- DatabaseQuery.call(client, delete_query) do
      ...
      {:error, reason} ->
        _ =
          Logger.warn(
            "Database error: cannot delete values. Reason: #{inspect(reason)}.",
            tag: "db_error"
          )
  ...
  def delete_values(
    ...
    with {:ok, result} <-
           fetch_all_paths_and_endpoint_ids(
             client,
             device_id,
             interface_descriptor
           ),
         :ok <-
           delete_all_paths_values(
             client,
             device_id,
             interface_descriptor,
             result
  ...
  def delete_path_values(
    ...
    with {:ok, _res} <- DatabaseQuery.call(client, delete_query) do
      ...
      {:error, reason} ->
        _ =
          Logger.warn(
            "Database error: cannot delete path values. Reason: #{inspect(reason)}.",
            tag: "db_error"
          )
  ...
  defp delete_all_paths(
    ...
    with {:ok, _result} <- DatabaseQuery.call(client, all_paths_query) do
      ...
      {:error, reason} ->
        _ =
          Logger.warn(
            "Database error while deleting all paths: #{inspect(reason)}.",
            tag: "db_error"
          )
  ...
  def fetch_interface(client, interface_name, interface_major) do
    ...
    with {:ok, result} <- DatabaseQuery.call(client, query),
         interface_row when is_list(interface_row) <-
           DatabaseResult.head(result),
         {:ok, interface_id} <- Keyword.fetch(interface_row, :interface_id),
         endpoints_query <-
           DatabaseQuery.put(endpoints_query, :interface_id, interface_id),
  ...
  def get_interfaces_list(client) do
    ...
    with {:ok, result} <- DatabaseQuery.call(client, query) do
      ...
      {:error, reason} ->
        _ =
          Logger.warn("Database error: failed with reason: #{inspect(reason)}.",
            tag: "db_error"
          )
  ...
  def install_trigger(client, trigger) do
    ...
    insert_query =
      ...
      |> DatabaseQuery.put(
        :trigger_uuid,
        :uuid.uuid_to_string(trigger.trigger_uuid)
      )
  ...
  def install_simple_trigger(
    ...
    insert_simple_trigger_by_uuid_query =
      ...
      |> DatabaseQuery.put(
        :simple_trigger_id,
        :uuid.uuid_to_string(simple_trigger_id)
      )
    ...
    with {:ok, _res} <- DatabaseQuery.call(client, insert_simple_trigger_query),
         {:ok, _res} <-
           DatabaseQuery.call(client, insert_simple_trigger_by_uuid_query) do
      :ok
    else
      not_ok ->
        _ = Logger.warn("Database error: #{inspect(not_ok)}.", tag: "db_error")
  ...
  def install_trigger_policy_link(client, trigger_uuid, trigger_policy) do
    ...
    insert_trigger_with_policy_query =
      ...
      |> DatabaseQuery.put(
        :policy_group,
        "triggers-with-policy-#{trigger_policy}"
      )
    ...
    with {:ok, _result} <-
           DatabaseQuery.call(client, insert_trigger_with_policy_query),
         {:ok, _result} <-
           DatabaseQuery.call(client, insert_trigger_to_policy_query) do
      :ok
    else
      not_ok ->
        _ = Logger.warn("Database error: #{inspect(not_ok)}.", tag: "db_error")
  ...
  def delete_trigger_policy_link(client, trigger_uuid, trigger_policy) do
    ...
    with {:ok, _result} <-
           DatabaseQuery.call(client, delete_trigger_with_policy_query),
         {:ok, _result} <-
           DatabaseQuery.call(client, delete_trigger_to_policy_query) do
      :ok
    else
      not_ok ->
        _ = Logger.warn("Database error: #{inspect(not_ok)}.", tag: "db_error")
  ...
  def delete_trigger(client, trigger_name) do
    with {:ok, trigger_uuid} <- retrieve_trigger_uuid(client, trigger_name) do
      ...
      with {:ok, _result} <- DatabaseQuery.call(client, delete_trigger_query),
           {:ok, _result} <-
             DatabaseQuery.call(client, delete_trigger_by_name_query) do
        :ok
      else
        not_ok ->
          _ = Logger.warn("Database error: #{inspect(not_ok)}.", tag: "db_error")
  ...
  def retrieve_tagged_simple_trigger(
        client,
        parent_trigger_uuid,
        simple_trigger_uuid
      ) do
    with %{object_uuid: object_id, object_type: object_type} <-
      ...
      with {:ok, result} <-
             DatabaseQuery.call(client, retrieve_simple_trigger_query),
        ...
        not_ok ->
          _ =
            Logger.warn(
              "Possible inconsistency found: database error: #{inspect(not_ok)}.",
              tag: "db_error"
            )
  ...
  def delete_simple_trigger(client, parent_trigger_uuid, simple_trigger_uuid) do
    with %{object_uuid: object_id, object_type: object_type} <-
      ...
      delete_astarte_ref_query =
        ...
        |> DatabaseQuery.put(
          :simple_trigger_uuid,
          :uuid.uuid_to_string(simple_trigger_uuid)
        )

      with {:ok, _result} <-
             DatabaseQuery.call(client, delete_simple_trigger_query),
           {:ok, _result} <-
             DatabaseQuery.call(client, delete_astarte_ref_query) do
        :ok
      else
        not_ok ->
          _ = Logger.warn("Database error: #{inspect(not_ok)}.", tag: "db_error")
  ...
  defp retrieve_simple_trigger_astarte_ref(client, simple_trigger_uuid) do
    ...
    with {:ok, result} <-
           DatabaseQuery.call(client, retrieve_astarte_ref_query),
  ...
  def delete_trigger_policy(client, policy_name) do
    ...
    with {:ok, _result} <- DatabaseQuery.call(client, delete_policy),
         {:ok, _result} <-
           DatabaseQuery.call(client, delete_triggers_with_policy_group_query),
         {:ok, _result} <-
           DatabaseQuery.call(client, delete_trigger_to_policy_query) do
      :ok
    else
  ...
  def delete_alias_values!(realm_name, aliaz) do
    Xandra.Cluster.run(
      :xandra_device_deletion,
      &do_delete_alias_values!(&1, realm_name, aliaz)
    )
  end

  defp do_delete_alias_values!(conn, realm_name, aliaz) do
    statement = """
    DELETE FROM #{realm_name}.names
    WHERE object_name = :aliaz
    """
