...
defmodule Astarte.Pairing.Queries do
  ...
  def fetch_registered_devices_number(realm_name) do
    Xandra.Cluster.run(:xandra, &do_fetch_registered_devices_number(&1, realm_name))
  end
  ...
  defp do_fetch_registered_devices_number(conn, realm_name) do
