...
defmodule Astarte.Housekeeping.API.RPC.Housekeeping do
  ...
  defp device_registration_limit_to_proto(:remove), do: {:remove_limit, %RemoveLimit{}}
  defp device_registration_limit_to_proto(nil), do: nil

  defp device_registration_limit_to_proto(n) when is_integer(n),
    do: {:set_limit, %SetLimit{value: n}}
end
